...
public:
    ...
    static bool confirm_button(const char* label, ImVec2 size, float rounding);

    static bool rounded_default_color_button(const char* label, ImVec2 size, float rounding);

    static bool begin_rounded_list_box(const char* label, ImVec2 size, float rounding);

    static bool default_button(const char* label, ImVec2 size);

    static bool default_rounded_button(const char* label, ImVec2 size, float rounding);
};
